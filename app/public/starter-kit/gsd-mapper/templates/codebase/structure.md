...
- Usage: Reference from command with `@/Users/liamj/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/liamj/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/liamj/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
...
- Following existing conventions </guidelines>
