...
impact: CRITICAL
tags: executive, summary, c-level, decision-maker
---
...
The investment of [amount] returns [ROI] within [timeframe].
```
...
Without action, [cost of inaction].
```
...
□ Can stand alone without reading full proposal
```
