...
impact: HIGH
tags: follow-up, cadence, closing, objection, negotiation
---
...
[Phone number]. Looking forward to connecting."
```
...
"Would be valuable to walk Jennifer through the ROI section"
```
...
1. **Understand the why:** "Help me understand - is it budget, or value?"
2. **Reframe to value:** "Let's make sure the ROI justifies the investment"
3. **Trade, don't give:** "If we could do X, would you sign this week?"
...
matters most to you and answer questions in real-time."
```
