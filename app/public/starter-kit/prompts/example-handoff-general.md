...
# Example: General User Session Handoff
...
- **Tone:** Professional but warm. We are experts sharing knowledge, not lecturing. Use 'you' and 'your school' to speak directly to the reader.
- **UK English throughout** — organise, colour, behaviour, etc.
- **No fear-mongering** — do not use scare tactics or worst-case scenarios to sell. Focus on empowerment and proactive measures.
- **No competitor mentions** — keep the content vendor-neutral. We can reference 'modern safeguarding platforms' generically.
- **Length:** 800-1,000 words per post. Shorter is better — these readers are busy.
- **The DfE statistics** we found: 1 in 5 children have experienced online bullying (2024 survey), 78% of schools report increased demand for digital safeguarding tools, average school handles 4.2 safeguarding concerns per week that involve a digital element.
...
- When drafting Post 2, make the five questions genuinely useful — the kind of questions a safeguarding lead would actually want answered
...
- If you suggest including a statistic, please flag whether it is one of the three we already verified or a new one that I will need to check
