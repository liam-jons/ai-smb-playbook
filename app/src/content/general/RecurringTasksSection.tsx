...
const automationPatterns: AutomationPattern[] = [
  ...
  },
  {
    ...
    audienceColour: 'bg-violet-100 text-violet-800 dark:bg-violet-900/40 dark:text-violet-300',
    description:
    ...
    <div className="space-y-12">
      ...
      <section aria-labelledby="current-state-heading">
        ...
        <div className="space-y-3 max-w-prose">
          <p className="text-base leading-relaxed text-foreground">
            Claude does not have a built-in scheduler. There is no &ldquo;run this every Monday
            at 09:00&rdquo; feature within Claude itself. This is one of the most commonly asked
            questions, and it is important to be clear about it.
          </p>
          <p className="text-sm leading-relaxed text-muted-foreground">
            What Claude <strong>can</strong> do: execute complex, multi-step tasks when
            triggered. The triggering is the part that currently needs a human or an external
            system.
          </p>
          <p className="text-sm leading-relaxed text-muted-foreground">
            The landscape is evolving quickly. This section describes the current state as of
            early 2026 and flags where things are likely to change.
          </p>
        </div>

        <CalloutCard variant="important" title="The practical takeaway" className="mt-6">
          Think of Claude as a highly capable executor that you initiate, rather than a
          background service that runs on its own. The limitation is in the triggering, not the
          execution. Claude can already do the hard part (analysing, summarising, formatting,
          decision-making). Building your workflows now means you will be ready to automate the
          trigger as soon as the tooling catches up.
        </CalloutCard>
      </section>
      ...
      <section aria-labelledby="patterns-heading">
        ...
        <p className="mb-6 max-w-prose text-sm text-muted-foreground">
          Four proven patterns for automating recurring work with Claude, starting from the
          simplest.
        </p>
          ...
          <Collapsible open={whatsComingOpen} onOpenChange={setWhatsComingOpen}>
            ...
            <CollapsibleContent>
              <div className="mt-2 space-y-3 rounded-md border border-border bg-muted/20 px-4 py-4">
                <p className="text-sm leading-relaxed text-muted-foreground">
                  Anthropic and third-party developers are actively building scheduling and
                  trigger capabilities. The trajectory is clearly towards more autonomous
                  operation.
                </p>
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-foreground/30" aria-hidden="true" />
                    CoWork and similar agent environments are evolving towards persistent
                    background tasks
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-foreground/30" aria-hidden="true" />
                    API-based integrations are becoming more accessible, enabling external
                    schedulers to trigger Claude tasks more easily
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-foreground/30" aria-hidden="true" />
                    The best preparation: build your workflows as skills and prompts now, so
                    they are ready to plug into scheduling infrastructure as it becomes available
                  </li>
                </ul>
              </div>
            </CollapsibleContent>
      ...
      <section aria-labelledby="prompts-heading">
        ...
        <p className="mb-6 max-w-prose text-sm text-muted-foreground">
          Copy these prompts and paste them into Claude to get started with recurring task
          patterns.
        </p>
      ...
      <section aria-labelledby="getting-started-heading">
        ...
        <p className="mb-6 max-w-prose text-sm text-muted-foreground">
          Practical, actionable steps for Phew! staff to begin automating recurring work.
        </p>
  ...
  return (
    <>
      ...
      <div>
        ...
        <ol className="mt-1.5 space-y-1.5 text-sm text-muted-foreground" role="list">
      ...
      {pattern.additionalExamples?.map((example, i) => (
        <div key={i} className="rounded-md border-l-2 border-accent-foreground/20 bg-muted/30 px-4 py-3">
          <span className="text-xs font-medium text-muted-foreground">
      ...
      <div className="rounded-md bg-muted/30 px-3 py-2">
        <span className="text-xs font-medium text-muted-foreground">When to use: </span>
